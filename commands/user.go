...
func init() {
	...
	ListUsersCmd.Flags().StringP("roles", "r", "", "If supplied only users with the given role will be listed. If no value is supplied, users will be listed with their roles.")

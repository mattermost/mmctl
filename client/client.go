...
type Client interface {
	...
	GetUsersByRoles(roles string, page int, perPage int, etag string) ([]*model.User, *model.Response, error)
	GetUsersInTeam(teamID string, page, perPage int, etag string) ([]*model.User, *model.Response, error)
	GetUsersInTeamByRoles(teamID string, roles string, page int, perPage int, etag string) ([]*model.User, *model.Response, error)
